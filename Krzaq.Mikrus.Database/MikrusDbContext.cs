using Krzaq.Mikrus.Database.Tables.Friend;
using Krzaq.Mikrus.Database.Tables.Game;
using Krzaq.Mikrus.Database.Tables.Room;
using Krzaq.Mikrus.Database.Tables.RoomChat;
using Krzaq.Mikrus.Database.Tables.User;
using Krzaq.Mikrus.Database.Tables.UserStats;
using Microsoft.EntityFrameworkCore;

namespace Krzaq.Mikrus.Database
{
    public class MikrusDbContext(DbContextOptions<MikrusDbContext> options) : DbContext(options)
    {
